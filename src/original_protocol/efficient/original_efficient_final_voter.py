"""
OriginalEfficientFinalVoter class for the original efficient variant of the e-voting protocol.
...
class OriginalEfficientFinalVoter(EfficientFinalVoter):
    ...
    def run(self) -> None:
        """
        Runs the final voter operations including receiving masking values and sending
        the
        encoded vote.
        """
        self.start_server()
